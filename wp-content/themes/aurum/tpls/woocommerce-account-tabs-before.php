	...
	<div class="col-lg-3 col-md-3 col-sm-4 my-account-tabs-env">
		<div class="my-account-tabs">
			<div class="user-profile">
				...
				<a class="logout" href="<?php echo $logout_url; ?>"><?php _e('Log Out', TD); ?></a>
			</div>
			<ul>
				...
				<li><a href="<?php echo $account_url; ?>#woocommerce-social-login"><?php _e('My Social Login Accounts', TD); ?></a></li>
				<?php endif; ?>
